...
namespace SolastaPurpleDragonKnightFighterSubclass
{
    public class Main
    {
        ...
        {
            DirectoryInfo directoryInfo = new DirectoryInfo($@"{UnityModManager.modsPath}/SolastaPurpleDragonKnightFighterSubclass");
            FileInfo[] files = directoryInfo.GetFiles($"Translations-??.txt");

            foreach (var file in files)
            {
                var filename = $@"{UnityModManager.modsPath}/SolastaPurpleDragonKnightFighterSubclass/{file.Name}";
        ...
        internal static void ModEntryPoint()
        {
            ...
            //
            skeleton.GuiPresentation.Title = "SolastaPurpleDragonKnightFighterSubclass/&FancySkeletonTitle";
            skeleton.GuiPresentation.Description = "SolastaPurpleDragonKnightFighterSubclass/&FancySkeletonDescription";
        }
    }
}
